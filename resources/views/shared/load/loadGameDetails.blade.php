...
<div class="details relative">
  <a href="{{ route('game.lobby', ['game' => $game->id]) }}"
    class="block w-full text-lg font-semibold text-center border-2 border-zinc-100 my-4 py-2 rounded bg-zinc-50 hover:bg-gray-700 hover:text-white transition-all md:mx-auto">Join lobby</a>
  ...
  <div class="rate">
    ...
    <div class="comment">
      <form action="" method="post">
        <textarea name="comment" cols="30" rows="10" class="py-4"></textarea>
