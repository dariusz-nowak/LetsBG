<div class="fixed w-full border-b-2 bg-slate-100 border-gray-50 shadow-md z-50">
  <div class="flex relative px-5 pt-3 pb-2">
    <div class="nav basis-5/12">
      <svg class="nav-icon h-6 w-6 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
      </svg>
      <div
        class="nav-container flex flex-col absolute top-11 left-0 h-0 px-5 py-2 w-full bg-gray-100 border-b-2 overflow-hidden invisible transition-all">
        <a href="{{ route('homepage') }}" class="block px-4 py-1 font-semibold">Homepage</a>
        <a href="
        @auth {{ route('offer.show', ['language' => $userSettings->language ]) }}
        @else {{ route('offer.show') }} @endauth
        " class="block px-4 py-1 font-semibold">Offer</a>
        <a href="{{ route('homepage') }}" class="block px-4 py-1 font-semibold">Polityka prywatności</a>
        <a href="{{ route('homepage') }}" class="block px-4 py-1 font-semibold">Regulamin</a>
      </div>
    </div>
    <div class="logo basis-2/12 hidden md:block">
      <a href="{{ route('homepage') }}" class="block font-semibold">LetsBG!</a>
    </div>
    <div class="menu basis-7/12 flex justify-end md:basis-5/12">
      <div class="favorites mx-2">
        ...
        <div
          class="fav-container absolute top-11 left-0 w-full h-0 px-5 py-2 bg-gray-100 border-b-2 overflow-x-scroll overflow-y-hidden invisible whitespace-nowrap transition-all">
        </div>
      ...
      <div class="profile mx-2">
        ...
        <div
          class="user-container flex justify-end absolute top-11 left-0 h-0 px-5 py-2 w-full bg-gray-100 border-b-2 overflow-hidden invisible transition-all">
          @auth
...
<div class="fixed w-full mt-60  px-5 pt-3 pb-2 border-b-2 bg-slate-100 border-gray-50 shadow-md z-50">
