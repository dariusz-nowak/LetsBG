<x-guest-layout>
  <x-jet-authentication-card>
    <h1 class="w-full mb-4 text-center text-xl font-bold">Register</h1>
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="mt-4">
        ...
        <select name="currency" class="w-full border-gray-300">
      ...
      <div class="mt-4">
        ...
        <select name="language" class="w-full border-gray-300">
