    ...
    <div class="comment relative my-4 border-2 rounded-xl">
      <div class="header flex flex-col border-b-2 md:flex-row">
        ...
        <div class="likes basis-1/2 flex justify-end">
          <p class="likes p-2 text-left">{{ $comment['commentId'] }} likes</p>
          <form action="{{ route('offer.like', ['userId' => $comment['userId']]) }}" method="post">
            <label>
              <svg class="h-8 w-8 m-1 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
